...
NAME_PATTERNS_REGEX = (
    ...
    # Stem-match (Postgres \w не покриває кирилицю → використовуємо substring).
    # Покриває: додатковий/додатково/додаткові/дополнительный/add-on/addon/add on
    r"додатков|дополнительн|add[- ]?on)"
)
